...
#redefinition from colibricore_classed.pxd, doesn't work if cimported
#ctypedef cPatternMap[uint32_t,cBaseValueHandler[uint32_t],uint64_t] cy_t_relationmap
#ctypedef cPatternMap[double,cBaseValueHandler[double],uint64_t] cy_t_relationmap_double
#ctypedef cPatternMap[uint32_t,cBaseValueHandler[uint32_t],uint64_t].iterator cy_t_relationmap_iterator
#ctypedef cPatternMap[double,cBaseValueHandler[double],uint64_t].iterator cy_t_relationmap_double_iterator
