...
\hline
\end{DoxyParams}
\hypertarget{classPattern_a4f080abb2e6bb11fea1b91a68c59f89b}{}\index{Pattern@{Pattern}!Pattern@{Pattern}}
\index{Pattern@{Pattern}!Pattern@{Pattern}}
\subsubsection[{Pattern(const Pattern \&ref, int begin, int length)}]{\setlength{\rightskip}{0pt plus 5cm}Pattern\+::\+Pattern (
\begin{DoxyParamCaption}
\item[{const {\bf Pattern} \&}]{ref, }
\item[{int}]{begin, }
\item[{int}]{length}
\end{DoxyParamCaption}
)}\label{classPattern_a4f080abb2e6bb11fea1b91a68c59f89b}
...
\hline
\end{DoxyParams}
\hypertarget{classPattern_ad981fd3fe3723d68226c98c0a3891c13}{}\index{Pattern@{Pattern}!Pattern@{Pattern}}
\index{Pattern@{Pattern}!Pattern@{Pattern}}
\subsubsection[{Pattern(const Pattern\+Pointer \&ref, int begin, int length)}]{\setlength{\rightskip}{0pt plus 5cm}Pattern\+::\+Pattern (
\begin{DoxyParamCaption}
\item[{const {\bf Pattern\+Pointer} \&}]{ref, }
\item[{int}]{begin, }
\item[{int}]{length}
\end{DoxyParamCaption}
)}\label{classPattern_ad981fd3fe3723d68226c98c0a3891c13}
...
\hypertarget{classPattern_a94cb62534e311b8d78561e8e52780829}{}\index{Pattern@{Pattern}!Pattern@{Pattern}}
\index{Pattern@{Pattern}!Pattern@{Pattern}}
\subsubsection[{Pattern(std\+::istream $\ast$in, bool ignoreeol=false, bool debug=false)}]{\setlength{\rightskip}{0pt plus 5cm}Pattern\+::\+Pattern (
\begin{DoxyParamCaption}
\item[{std\+::istream $\ast$}]{in, }
\item[{bool}]{ignoreeol = {\ttfamily false}, }
\item[{bool}]{debug = {\ttfamily false}}
\end{DoxyParamCaption}
)}\label{classPattern_a94cb62534e311b8d78561e8e52780829}
...
\hline
\end{DoxyParams}
\hypertarget{classPattern_a0a3103f6112a56d00a82bdd56cc55afb}{}\index{Pattern@{Pattern}!Pattern@{Pattern}}
\index{Pattern@{Pattern}!Pattern@{Pattern}}
\subsubsection[{Pattern(std\+::istream $\ast$in, unsigned char $\ast$buffer, int maxbuffersize, bool ignoreeol=false, bool debug=false)}]{\setlength{\rightskip}{0pt plus 5cm}Pattern\+::\+Pattern (
\begin{DoxyParamCaption}
\item[{std\+::istream $\ast$}]{in, }
\item[{unsigned char $\ast$}]{buffer, }
\item[{int}]{maxbuffersize, }
\item[{bool}]{ignoreeol = {\ttfamily false}, }
\item[{bool}]{debug = {\ttfamily false}}
\end{DoxyParamCaption}
)}\label{classPattern_a0a3103f6112a56d00a82bdd56cc55afb}
...
\hypertarget{classPattern_a043a073515f0a5c7a11492f9f47b2e55}{}\index{Pattern@{Pattern}!addflexgaps@{addflexgaps}}
\index{addflexgaps@{addflexgaps}!Pattern@{Pattern}}
\subsubsection[{addflexgaps(std\+::vector$<$ std\+::pair$<$ int, int $>$ $>$ \&gaps) const }]{\setlength{\rightskip}{0pt plus 5cm}{\bf Pattern} Pattern\+::addflexgaps (
\begin{DoxyParamCaption}
\item[{std\+::vector$<$ std\+::pair$<$ int, int $>$ $>$ \&}]{gaps}
\end{DoxyParamCaption}
) const}\label{classPattern_a043a073515f0a5c7a11492f9f47b2e55}
...
A flexgram 
\end{DoxyReturn}
\hypertarget{classPattern_a0f697977abd217fe4e57a4016c3bb9e0}{}\index{Pattern@{Pattern}!addskip@{addskip}}
\index{addskip@{addskip}!Pattern@{Pattern}}
\subsubsection[{addskip(std\+::pair$<$ int, int $>$ gap) const }]{\setlength{\rightskip}{0pt plus 5cm}{\bf Pattern} Pattern\+::addskip (
\begin{DoxyParamCaption}
\item[{std\+::pair$<$ int, int $>$}]{gap}
\end{DoxyParamCaption}
) const}\label{classPattern_a0f697977abd217fe4e57a4016c3bb9e0}
...
\hline
\end{DoxyParams}
\hypertarget{classPattern_a4a93ba100dfde6f2f0a2914bce400ed0}{}\index{Pattern@{Pattern}!addskips@{addskips}}
\index{addskips@{addskips}!Pattern@{Pattern}}
\subsubsection[{addskips(std\+::vector$<$ std\+::pair$<$ int, int $>$ $>$ \&gaps) const }]{\setlength{\rightskip}{0pt plus 5cm}{\bf Pattern} Pattern\+::addskips (
\begin{DoxyParamCaption}
\item[{std\+::vector$<$ std\+::pair$<$ int, int $>$ $>$ \&}]{gaps}
\end{DoxyParamCaption}
) const}\label{classPattern_a4a93ba100dfde6f2f0a2914bce400ed0}
...
alias for \hyperlink{classPattern_a810d538d873a823d0b6dbe04d2faf334}{tostring()} \hypertarget{classPattern_af8d6a22c49da3a8aa470635bb67ece60}{}\index{Pattern@{Pattern}!extractskipcontent@{extractskipcontent}}
\index{extractskipcontent@{extractskipcontent}!Pattern@{Pattern}}
\subsubsection[{extractskipcontent(\+Pattern \&instance) const }]{\setlength{\rightskip}{0pt plus 5cm}{\bf Pattern} Pattern\+::extractskipcontent (
\begin{DoxyParamCaption}
\item[{{\bf Pattern} \&}]{instance}
\end{DoxyParamCaption}
) const}\label{classPattern_af8d6a22c49da3a8aa470635bb67ece60}
...
Finds all the gaps of a skipgram or flexgram., parts are the portions that are not skips and adds them to container as begin,length pairs... Thus \textquotesingle{}to be \{$\ast$\} not \{$\ast$\} be\textquotesingle{} has three parts. The gap-\/length of a flexgram will always be its minimum length one. \hypertarget{classPattern_a8b0f2c0b2e993631a44b3e7ba0acc380}{}\index{Pattern@{Pattern}!hash@{hash}}
\index{hash@{hash}!Pattern@{Pattern}}
\subsubsection[{hash(bool stripmarkers=false) const }]{\setlength{\rightskip}{0pt plus 5cm}const size\+\_\+t Pattern\+::hash (
\begin{DoxyParamCaption}
\item[{bool}]{stripmarkers = {\ttfamily false}}
\end{DoxyParamCaption}
) const}\label{classPattern_a8b0f2c0b2e993631a44b3e7ba0acc380}
...
Finds all the parts of a skipgram, parts are the portions that are not skips and adds them to container... Thus \textquotesingle{}to be \{$\ast$\} not \{$\ast$\} be\textquotesingle{} has three parts \hypertarget{classPattern_acde3a00e476df661b46cc28318e32077}{}\index{Pattern@{Pattern}!parts@{parts}}
\index{parts@{parts}!Pattern@{Pattern}}
...
Finds all the parts of a skipgram, parts are the portions that are not skips and adds them to container as begin,length pairs... Thus \textquotesingle{}to be \{$\ast$\} not \{$\ast$\} be\textquotesingle{} has three parts \hypertarget{classPattern_a81cbadcd914912e5ea61a2aadd6f4fc0}{}\index{Pattern@{Pattern}!reader\+\_\+marker@{reader\+\_\+marker}}
\index{reader\+\_\+marker@{reader\+\_\+marker}!Pattern@{Pattern}}
\subsubsection[{reader\+\_\+marker(unsigned char $\ast$\+\_\+data, std\+::istream $\ast$in)}]{\setlength{\rightskip}{0pt plus 5cm}void Pattern\+::reader\+\_\+marker (
\begin{DoxyParamCaption}
\item[{unsigned char $\ast$}]{\+\_\+data, }
\item[{std\+::istream $\ast$}]{in}
\end{DoxyParamCaption}
)\hspace{0.3cm}{\ttfamily [protected]}}\label{classPattern_a81cbadcd914912e5ea61a2aadd6f4fc0}
\hypertarget{classPattern_afab002bc06207214e84ff324becfe224}{}\index{Pattern@{Pattern}!replace@{replace}}
...
return the number of skips in this pattern \hypertarget{classPattern_a6a7b34dfc31443c28f4769a21ddebaad}{}\index{Pattern@{Pattern}!subngrams@{subngrams}}
\index{subngrams@{subngrams}!Pattern@{Pattern}}
\subsubsection[{subngrams(std\+::vector$<$ Pattern $>$ \&container, int minn=1, int maxn=9) const }]{\setlength{\rightskip}{0pt plus 5cm}int Pattern\+::subngrams (
\begin{DoxyParamCaption}
\item[{std\+::vector$<$ {\bf Pattern} $>$ \&}]{container, }
\item[{int}]{minn = {\ttfamily 1}, }
\item[{int}]{maxn = {\ttfamily 9}}
\end{DoxyParamCaption}
) const}\label{classPattern_a6a7b34dfc31443c28f4769a21ddebaad}
Adds all patterns (not just ngrams) of all sizes that are contained within the pattern to container. Does not extract skipgrams that are not directly present in the pattern. \hypertarget{classPattern_aae7ead84de1198aa1576b39baaceaf52}{}\index{Pattern@{Pattern}!subngrams@{subngrams}}
\index{subngrams@{subngrams}!Pattern@{Pattern}}
\subsubsection[{subngrams(std\+::vector$<$ Pattern\+Pointer $>$ \&container, int minn=1, int maxn=9) const }]{\setlength{\rightskip}{0pt plus 5cm}int Pattern\+::subngrams (
\begin{DoxyParamCaption}
\item[{std\+::vector$<$ {\bf Pattern\+Pointer} $>$ \&}]{container, }
\item[{int}]{minn = {\ttfamily 1}, }
\item[{int}]{maxn = {\ttfamily 9}}
\end{DoxyParamCaption}
) const}\label{classPattern_aae7ead84de1198aa1576b39baaceaf52}
...
Converts this pattern back into its string representation, using a classdecoder \hypertarget{classPattern_aea8bcb92b5b11ae358d7645de11a35fd}{}\index{Pattern@{Pattern}!tovector@{tovector}}
\index{tovector@{tovector}!Pattern@{Pattern}}
\subsubsection[{tovector() const }]{\setlength{\rightskip}{0pt plus 5cm}vector$<$ int $>$ Pattern\+::tovector (
\begin{DoxyParamCaption}
{}
\end{DoxyParamCaption}
) const}\label{classPattern_aea8bcb92b5b11ae358d7645de11a35fd}
Convert the pattern to a vector of integers, where the integers correspond to the token classes. \hypertarget{classPattern_ab5cf03f0619bd68238df9655501eb31e}{}\index{Pattern@{Pattern}!type@{type}}
\index{type@{type}!Pattern@{Pattern}}
\subsubsection[{type() const }]{\setlength{\rightskip}{0pt plus 5cm}const {\bf Structure\+Type} Pattern\+::type (
\begin{DoxyParamCaption}
{}
\end{DoxyParamCaption}
) const}\label{classPattern_ab5cf03f0619bd68238df9655501eb31e}
\hypertarget{classPattern_ad2325ce11035ced772f72dbfd4b57c01}{}\index{Pattern@{Pattern}!unknown@{unknown}}
...
\hypertarget{classPattern_a17d74bdb4862199e302eae994f4c376f}{}\index{Pattern@{Pattern}!write@{write}}
\index{write@{write}!Pattern@{Pattern}}
\subsubsection[{write(std\+::ostream $\ast$out) const }]{\setlength{\rightskip}{0pt plus 5cm}void Pattern\+::write (
\begin{DoxyParamCaption}
\item[{std\+::ostream $\ast$}]{out}
\end{DoxyParamCaption}
) const}\label{classPattern_a17d74bdb4862199e302eae994f4c376f}
...
This array holds the variable-\/width byte representation, it is always terminated by \textbackslash{}0 (E\+N\+D\+M\+A\+R\+K\+E\+R). Though public, you usually do not want to access it directly 
