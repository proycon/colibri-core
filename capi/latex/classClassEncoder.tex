...
\hypertarget{classClassEncoder_a434fc52c64ec960ef68daba4889695d6}{}\index{Class\+Encoder@{Class\+Encoder}!add@{add}}
\index{add@{add}!Class\+Encoder@{Class\+Encoder}}
\subsubsection[{add(std\+::string, unsigned int cls)}]{\setlength{\rightskip}{0pt plus 5cm}void Class\+Encoder\+::add (
\begin{DoxyParamCaption}
\item[{std\+::string}]{s, }
\item[{unsigned int}]{cls}
\end{DoxyParamCaption}
)}\label{classClassEncoder_a434fc52c64ec960ef68daba4889695d6}
...
\hypertarget{classClassEncoder_a7a778921ee3b6c24152bd4754c095780}{}\index{Class\+Encoder@{Class\+Encoder}!build@{build}}
\index{build@{build}!Class\+Encoder@{Class\+Encoder}}
\subsubsection[{build(const std\+::string \&filename)}]{\setlength{\rightskip}{0pt plus 5cm}void Class\+Encoder\+::build (
\begin{DoxyParamCaption}
\item[{const std\+::string \&}]{filename}
\end{DoxyParamCaption}
)}\label{classClassEncoder_a7a778921ee3b6c24152bd4754c095780}
...
\hline
\end{DoxyParams}
\hypertarget{classClassEncoder_a63dc79113097584b052b1c1aafb1450e}{}\index{Class\+Encoder@{Class\+Encoder}!build@{build}}
\index{build@{build}!Class\+Encoder@{Class\+Encoder}}
\subsubsection[{build(std\+::vector$<$ std\+::string $>$ \&files, bool quiet=false)}]{\setlength{\rightskip}{0pt plus 5cm}void Class\+Encoder\+::build (
\begin{DoxyParamCaption}
\item[{std\+::vector$<$ std\+::string $>$ \&}]{files, }
\item[{bool}]{quiet = {\ttfamily false}}
\end{DoxyParamCaption}
)}\label{classClassEncoder_a63dc79113097584b052b1c1aafb1450e}
...
\hline
\end{DoxyParams}
\hypertarget{classClassEncoder_a1d2503142bf80628342d63d4b1bc8c80}{}\index{Class\+Encoder@{Class\+Encoder}!buildclasses@{buildclasses}}
\index{buildclasses@{buildclasses}!Class\+Encoder@{Class\+Encoder}}
\subsubsection[{buildclasses(const std\+::unordered\+\_\+map$<$ std\+::string, int $>$ \&freqlist)}]{\setlength{\rightskip}{0pt plus 5cm}void Class\+Encoder\+::buildclasses (
\begin{DoxyParamCaption}
\item[{const std\+::unordered\+\_\+map$<$ std\+::string, int $>$ \&}]{freqlist}
\end{DoxyParamCaption}
)}\label{classClassEncoder_a1d2503142bf80628342d63d4b1bc8c80}
...
\end{DoxyReturn}
\hypertarget{classClassEncoder_a83e08eb6b43b6fceb95b0bdb1960348f}{}\index{Class\+Encoder@{Class\+Encoder}!encodefile@{encodefile}}
\index{encodefile@{encodefile}!Class\+Encoder@{Class\+Encoder}}
\subsubsection[{encodefile(std\+::istream $\ast$\+I\+N, std\+::ostream $\ast$\+O\+U\+T, bool allowunknown, bool autoaddunknown, bool quiet=false)}]{\setlength{\rightskip}{0pt plus 5cm}void Class\+Encoder\+::encodefile (
\begin{DoxyParamCaption}
...
\item[{bool}]{quiet = {\ttfamily false}}
\end{DoxyParamCaption}
)}\label{classClassEncoder_a83e08eb6b43b6fceb95b0bdb1960348f}
Create a class-\/encoded corpus file from a plain-\/text corpus file. Each of the units of interest (e.\+g sentences) should occupy a single line (i.\+e., ~\newline
 delimited) 
\begin{DoxyParams}{Parameters}
...
Computes how many bytes the class repesentation for this input line would take \hypertarget{classClassEncoder_a31582938ee64039dda806490f70ede04}{}\index{Class\+Encoder@{Class\+Encoder}!processcorpus@{processcorpus}}
\index{processcorpus@{processcorpus}!Class\+Encoder@{Class\+Encoder}}
\subsubsection[{processcorpus(const std\+::string \&filename, std\+::unordered\+\_\+map$<$ std\+::string, int $>$ \&freqlist)}]{\setlength{\rightskip}{0pt plus 5cm}void Class\+Encoder\+::processcorpus (
\begin{DoxyParamCaption}
\item[{const std\+::string \&}]{filename, }
\item[{std\+::unordered\+\_\+map$<$ std\+::string, int $>$ \&}]{freqlist}
\end{DoxyParamCaption}
)}\label{classClassEncoder_a31582938ee64039dda806490f70ede04}
Count word frequency in a given plain-\/text corpus. 
\begin{DoxyParams}{Parameters}
{\em filename} & The corpus file \\
\hline
{\em freqlist} & The resulting frequency list, should be shared between multiple calls to \hyperlink{classClassEncoder_a31582938ee64039dda806490f70ede04}{processcorpus()} \\
\hline
\end{DoxyParams}
\hypertarget{classClassEncoder_a51df3eebfbcf89c57deaa1a43056be34}{}\index{Class\+Encoder@{Class\+Encoder}!processcorpus@{processcorpus}}
\index{processcorpus@{processcorpus}!Class\+Encoder@{Class\+Encoder}}
\subsubsection[{processcorpus(std\+::istream $\ast$in, std\+::unordered\+\_\+map$<$ std\+::string, int $>$ \&freqlist)}]{\setlength{\rightskip}{0pt plus 5cm}void Class\+Encoder\+::processcorpus (
\begin{DoxyParamCaption}
\item[{std\+::istream $\ast$}]{in, }
\item[{std\+::unordered\+\_\+map$<$ std\+::string, int $>$ \&}]{freqlist}
\end{DoxyParamCaption}
)}\label{classClassEncoder_a51df3eebfbcf89c57deaa1a43056be34}
Count word frequency in a given plain-\/text corpus. 
\begin{DoxyParams}{Parameters}
