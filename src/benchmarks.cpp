...
int main( int argc, char *argv[] ) {
	...
	if (testnr == 10) {
        Measurement m = begin(string("10 - Training unindexed PatternModel from file: threshold 1, up to 3-grams, no skipgrams"));
        PatternModelOptions options;
    ...
    if (testnr == 11) {
        Measurement m = begin(string("11 - Training indexed PatternModel from preloaded corpus: threshold 2, up to 8-grams, no skipgrams"));
        PatternModelOptions options;
        options.MINTOKENS = 2; options.MAXLENGTH = 8; options.DOSKIPGRAMS = false;
    ...
    if (testnr == 12) {
        Measurement m = begin(string("12 - Training indexed PatternModel from preloaded corpus: threshold 2, up to 8-grams, with skipgrams"));
        PatternModelOptions options;
    ...
    if (testnr == 13) {
        Measurement m = begin(string("13 - Training unindexed PatternPointerModel from preloaded corpus: threshold 2, up to 8-grams, no skipgrams"));
        PatternModelOptions options;
    ...
    if (testnr == 14) {
        Measurement m = begin(string("14 - Training unindexed PatternPointerModel from preloaded corpus: threshold 2, up to 8-grams, with skipgrams (exhaustive)"));
        PatternModelOptions options;
        options.MINTOKENS = 2; options.MAXLENGTH = 8; options.DOSKIPGRAMS = true; options.DOSKIPGRAMS_EXHAUSTIVE = true;
        PatternPointerModel<uint32_t> model(&corpus);
        model.train(datafile, options);
    ...
    if (testnr == 15) {
        Measurement m = begin(string("15 - Training indexed PatternPointerModel from preloaded corpus: threshold 2, up to 8-grams, no skipgrams"));
        PatternModelOptions options;
        options.MINTOKENS = 2; options.MAXLENGTH = 8;
    ...
    if (testnr == 16) {
        Measurement m = begin(string("16 - Training unindexed PatternModel<HashOrderedPatternMap> from preloaded corpus: threshold 2, up to 8-grams, no skipgrams"));
        PatternModelOptions options;
        options.MINTOKENS = 2; options.MAXLENGTH = 8; options.DOSKIPGRAMS = false;
